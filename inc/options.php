 ...
 * $datos_footer_options = get_option( 'datos_footer_option_name' ); // Array of All Options
 * $direccin_0 = $datos_footer_options['direccin_0']; // Dirección
 * $editores_1 = $datos_footer_options['editores_1']; // Editores
 * $registro_n_o_texto_2 = $datos_footer_options['registro_n_o_texto_2']; // Registro (nº o texto)
 * $n_edicin_3 = $datos_footer_options['n_edicin_3']; // Nº Edición
 * $fecha_4 = $datos_footer_options['fecha_4']; // Fecha
 */
