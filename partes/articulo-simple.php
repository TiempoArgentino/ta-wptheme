        ...
        <div class="article-body mt-3">
            <div class="pl-lg-5">
                <p>Durante el siglo XIV, la denominada peste negra se extendió por Asia Menor, Oriente Medio,
                    el norte de Africa y Europa, alcanzando su pico máximo entre 1346 y 1353 con un saldo aproximado de
                    20
                    millones de muertes.
                ...
                <p class="mt-3">El gobernador sobreactuó su gesta por la salud pública con dos medidas sorprendentes: la
                    súbita
                ...
                <div class="anuncio-seccion text-center mt-3">
                    ...
                    <div class="anuncio-container">
                        <div>
                            <p>El autor <a href="">@RRagendorfer</a> estará respondiendo prenguntas relacionadas a este
                                tema en el
                    ...
                    <div class="p-3">
                        ...
                        <div class="content">
                            <p>El gobernador sobreactuó su gesta por la salud pública con dos medidas sorprendentes: “la
                                súbita expulsión de 61 migrantes de países latinoamericanos –quienes fueron arreados en
                                un
                                micro hacia Buenos Aires–” y el anunció de poner una faja en las casas de posibles
                                infectados.
                            </p>
                            <p class="mt-2">Durante el siglo XIV, la denominada peste negra se extendió por <span>Asia
                                    Menor, Oriente
                                    Medio,
                                    el norte de Africa y Europa,</span> alcanzando su pico máximo entre 1346 y 1353 con
                                un
                                saldo
                                aproximado de 20 millones de muertes. En algunos estados de la península ibérica, la
                                Santa
                                Inquisición impulsó. </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-3">
                        ...
                        <div class="content">
                            ...
                            <p><span>Sábado 26 de Septiembre,
                                    20:00 hs Vía:</span> <a href="" class="red-font">experienciapiazzolla.com</a> y <a
                                    href="" class="red-font">página de YouTube
                                    del CC
                                    Konex.</a>
                            </p>
