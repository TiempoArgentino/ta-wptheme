    ...
    <div class="ta-socios-block mx-auto px-3 py-4">
        ...
        <!-- <div class="optional-content mt-3">
                ...
                <p>Durante el siglo XIV, la denominada peste negra se extendió por Asia Menor, Oriente Medio,
                    el norte de Africa y Europa, alcanzando su pico máximo entre 1346 y 1353 con un saldo
                    aproximado de 20 millones de muertes. En algunos estados de la península ibérica, la Santa
                    Inquisición impulsó.El gobernador sobreactuó su gesta por la salud pública con dos medidas
